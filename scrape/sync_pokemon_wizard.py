...
Each run appends a record to pokemon_wizard_sync_skips.json (skipped cards with reason codes).
Regenerate sets_missing_wizard_price_history.txt to include those rows in the skip subsection.
...
def run(
    ...
    *,
    ...
    rep_path = output_path.parent / (output_path.name + ".pokemon_wizard_sync_report.json")
